...
export default {
  ...
  antServerRunning: false, // we'll use this to define if the AntServer is running or not, and also used to define startup behaviour (false means starts with server stopped/off)
